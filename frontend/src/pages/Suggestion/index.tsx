...
export default function Suggestion() {
  ...
  const onSubmitFeedback = (e: FormEvent<HTMLFormElement>): void => {
    ...
    if (checkIfObjectIsEmpty(feedbackFormData) || !('score' in feedbackFormData) || !feedbackFormData.score)
      return;
    ...
    <div className="isolate px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-xl md:text-2xl leading-8 text-gray-600">
          Sugira enquetes, pesquisas, votações, ou qualquer outro tipo de interação que você gostaria de ver por
          aqui.
        </p>
      </div>
          ...
          <div className="text-center my-4">
            ...
            <div className="mt-4 flex items-center font-bold w-full justify-between text-lg">
              ...
              <button
                ...
                disabled={isFetchingFeedback}
                onClick={() =>
                  setFeedbackFormData(prev => ({ ...prev, score: prev.score === 'bad' ? null : 'bad' }))
                }
              >
                <BsEmojiFrownFill
                  className={classNames(
              ...
              <button
                ...
                disabled={isFetchingFeedback}
                onClick={() =>
                  setFeedbackFormData(prev => ({ ...prev, score: prev.score === 'good' ? null : 'good' }))
                }
              >
                <BsEmojiSmileFill
                  className={classNames(
